...
public class Primary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoCompleteTextView actvStart = findViewById(R.id.StartSelection);
        AutoCompleteTextView actvEnd = findViewById(R.id.EndSelection);
        RadioGroup StartRadio = findViewById(R.id.StartRadio);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.EndRadioW), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        StartRadio.setOnCheckedChangeListener((radioGroup, i) -> {
            RadioButton selected = findViewById(i);
            String selectedText = selected.getText().toString();

            activateListStart(actvStart, selectedText);
        });
        ...
        EndRadio.setOnCheckedChangeListener((radioGroup, i) -> {
            ...
            activateListEnd(actvEnd, selectedText);
        });
    }
    ...
    private void activateListStart(AutoCompleteTextView actv, String selectedText){
    ...
    private void activateListEnd(AutoCompleteTextView actv, String selectedText){
